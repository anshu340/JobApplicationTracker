...
ALTER TABLE JobApplications
ADD CONSTRAINT FK_JobApplications_ApplicationStatus
    FOREIGN KEY (ApplicationStatus) REFERENCES ApplicationStatus(ApplicationStatusId)
    ON DELETE CASCADE;

ALTER TABLE JobApplications
ADD CONSTRAINT FK_JobApplications_Job
