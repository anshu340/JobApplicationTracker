...
public class JobSeekerSkillsController(IJobSeekerSkillRepository jobSeekersSkillsService) : ControllerBase
{
    [HttpGet]
    ...
    public async Task<IActionResult> SubmitJobSeekerSkills([FromBody] JobSeekerSkill jobSeekerSkillsDto)
    {
